<?php
  $data_user = $this->db->get_where("user", ["user_id" => $this->session->userdata("user_id")])->row_array();
?>
...
<aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active"><a href="<?php echo base_url("chat"); ?>"><i class="fa fa-comments"></i> <span>Chat</span></a></li>
      </ul>
    </section>
    <!-- /.sidebar -->
  </aside>